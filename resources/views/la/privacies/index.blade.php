...
@section("contentheader_title", "Privacies")
@section("contentheader_description", "Privacies listing")
@section("section", "Privacies")
@section("sub_section", "Listing")
@section("htmlheader_title", "Privacies Listing")

@section("headerElems")
@la_access("Privacies", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Privacy</button>
@endla_access
@endsection
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/privacy_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
